...
*/
#ifndef STM32F103_FLASH_DMA_STDSPI_PORT_H
#define STM32F103_FLASH_DMA_STDSPI_PORT_H
...
#define FLASH_RCC_APBPeriph_DMA      RCC_AHBPeriph_DMA1
#define FLASH_DMAx                   DMA1
#define FLASH_RX_DMAy_Channelx       DMA1_Channel4 //FLASH SPI2 RX所处DMA通道
#define FLASH_TX_DMAy_Channelx       DMA1_Channel5 //FLASH SPI2 TX所处DMA通道
#define FLASH_RX_DMA_COMPLETE_FLAG   DMA1_FLAG_TC4
#define FLASH_TX_DMA_COMPLETE_FLAG   DMA1_FLAG_TC5
#define FLASH_DMA_PeripheralBaseAddr (&SPI2->DR)
...
//向SPI读取一个数据
#define read_flash_spi_dat(dat)      (FLASH_SPIx->DR)
//等待SPI接收完
#define wait_flash_dmaspirx_done()   do{while(DMA_GetFlagStatus(FLASH_RX_DMA_COMPLETE_FLAG));}while(0)
