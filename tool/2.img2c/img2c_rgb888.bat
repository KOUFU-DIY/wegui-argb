...
..\0.tool\windows\img2bin_indexqoimask\img2bin_indexqoimask.exe --quantize-bits 6 --input .\input\alpha\A8_indexqoimask_2bin --output .\output\bin
:: 清空取模bin的日志
...
..\0.tool\windows\img2bin_indexqoimask\img2bin_indexqoimask.exe --quantize-bits 6 --input .\input\alpha\A8_indexqoimask_2c --output .\output\c\temp
:: 将temp下的bin转换成单个.c.h
