...
#ifndef STM32F030_LCD_SOFT_4SPI_PORT_H
#define STM32F030_LCD_SOFT_4SPI_PORT_H
...
/* SCL — PB13 */
#define LCD_SCL_Clr()     do{GPIOB->BRR = GPIO_Pin_13;}while(0)//GPIO_ResetBits(GPIOB, GPIO_Pin_13)
#define LCD_SCL_Set()     do{GPIOB->BSRR = GPIO_Pin_13;}while(0)//GPIO_SetBits(GPIOB, GPIO_Pin_13)
