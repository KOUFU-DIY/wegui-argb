...
void we_flash_img_simple_demo_init(we_lcd_t *lcd)
{
    ...
    ok |= we_flash_img_obj_init(&fl_img1, lcd, 56, 90, bin_addr_table[DEMO_RGB565_RAW_BE_64X80_ID], 255U);
    ok |= we_flash_img_obj_init(&fl_img2, lcd, 128, 48, bin_addr_table[DEMO_RGB565_INDEXQOI_BE_128X64_ID], 255U);
    ok |= we_flash_img_obj_init(&fl_img3, lcd, 10, 130, bin_addr_table[DEMO_ARGB8565_INDEXQOI_BE_80X80_ID], 255U);
